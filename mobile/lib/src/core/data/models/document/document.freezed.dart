...
abstract class $DocumentCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? title, String? shareLink});
}
...
class _$DocumentImpl implements _Document {
  _$DocumentImpl({this.id, this.title, this.shareLink});
  ...
  @override
  String toString() {
    return 'Document(id: $id, title: $title, shareLink: $shareLink)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, shareLink);
...
abstract class _Document implements Document {
  factory _Document(
      {final int? id,
      final String? title,
      final String? shareLink}) = _$DocumentImpl;
