...
class MyServiceListRowItem extends StatelessWidget {
  final ProfileController profileController;

  const MyServiceListRowItem({super.key, required this.profileController});
  ...
  String getMenuText(UserMode? userMode) {
    switch (userMode) {
      ...
      case UserMode.owner:
        return 'Мои услуги';
      default:
        return 'Мои объявления по услугам';
    }
  }
}
