...
class SMCreatedRequestDetailController extends AppSafeChangeNotifier {
  ...
  SMCreatedRequestDetailController(this.requestId);

  SpecializedMachineryRequest? _requestDetails;

  SpecializedMachineryRequest? get requestDetails => _requestDetails;
  ...
  Future<void> loadDetails(BuildContext context) async {
    ...
    _requestDetails =
        await _requestApiClient.getSMRequestDetail(requestId);
    if (!context.mounted) return;
