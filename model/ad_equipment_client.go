...
// gorm:"foreignKey:ID;references:SubCategoryID"
...
type AdEquipmentClient struct {
	...
	Documents              []Document           `json:"document"                 gorm:"many2many:ad_equipment_client_documents"`
	UrlDocument            []string             `json:"url_foto"                 gorm:"-"`
}

type FilterAdEquipmentClients struct {
	UserDetail                 *bool
	CityDetail                 *bool
	EquipmentSubСategoryDetail *bool
...
type AdEquipmentClientDocuments struct {
	AdEquipmentClientID int
	DocumentID          int
}
