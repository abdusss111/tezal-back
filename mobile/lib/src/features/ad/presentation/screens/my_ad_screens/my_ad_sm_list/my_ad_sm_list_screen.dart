...
class MyAdSmListScreen extends StatefulWidget {
  const MyAdSmListScreen({super.key});

  @override
  State<MyAdSmListScreen> createState() => _MyAdSmListScreenState();
}

class _MyAdSmListScreenState extends State<MyAdSmListScreen> {
  final constructionRepo = AdConstructionMaterialsRepository();

  var uniqueKey = UniqueKey();
  // late Future<List<List<AdListRowData>>> getFutureForClient;
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Payload?>(
        future: Provider.of<MyAdSMListController>(context, listen: false)
            .getPayload(),
                ...
                child: Builder(builder: (context) {
                  return Scaffold(
                      ...
                      body: GlobalFutureBuilder(
                          key: uniqueKey,
                          future: Provider.of<MyAdSMListController>(context,
                                  listen: false)
                              .getClientData(),
                          buildWidget: (requests) {
                            ...
                            final deletedAds = request
                                .where((e) =>
                                    e.status == RequestStatus.DELETED.name &&
                                    (e.deletedAt != null))
                                .toList();

                            return Consumer<MyAdSMListController>(
                              ...
                              return TabBarView(children: [
                                MyAdClientListView(
                                  ...
                                  onTapCreate: () => context.pushNamed(
                                      AppRouteNames.createAdSMForClient,
                    ...
                    buildWidget: (requests) {
                      ...
                      return Consumer<MyAdSMListController>(
                        ...
                        return MyAdClientListView(
                          ...
                          onTapCreate: () => context.pushNamed(
                              AppRouteNames.createAdSMForDriverOrOwnerFromMyADs,
                              extra: CreateAdOrRequestEnum.ad),
                        );
                      });
                    }));
          }
